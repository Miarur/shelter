...
// variables of card_item 
const petContainer = document.querySelector('.pet__container');
const petItem = document.querySelectorAll('.pet__item');
const pet_img = document.querySelectorAll('.item__image');
const pet_content = document.querySelectorAll('.item__content')
...
function closeModal() {
  petContainer.classList.remove('show');
